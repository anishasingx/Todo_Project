                ...
                <div class="row justify-content-center text-center border g-3">
                    ...
                    <div class="col-12 col-md-6 ">
                        <div class="row justify-content-center g-2">
                            ...
                            <div class="col-2"><a href="./controller/DeleteTodo.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this record?');"><i class="bi bi-trash3-fill"></i></a></div>
                        </div>
